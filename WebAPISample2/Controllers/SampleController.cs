...
// xử lý các yêu cầu HTTP từ phía client và điều hướng chúng tới các phương thức thích hợp trong ISampleService.
namespace WebAPISample.Controllers
{
    [ApiController] // Đánh dấu lớp này là một API Controller trong ASP.NET Core. 
    [Route("api/[controller]")] //  xác định route prefix
